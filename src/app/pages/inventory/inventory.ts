...
@Component({
    ...
    template: ` <div class="card">
            <div class="font-semibold text-xl mb-4">Inventory</div>
            <p-table
                #dt1
                [value]="customers1"
                dataKey="id"
                ...
                <ng-template #header>
                    <tr>
                        ...
                        <th style="min-width: 14rem">
                            <div class="flex justify-between items-center">
                                Prouduct
                                <p-columnFilter field="Prouduct" matchMode="in" display="menu" [showMatchModes]="false" [showOperator]="false" [showAddButton]="false">
                                    <ng-template #header>
                        ...
                        <th style="min-width: 8rem">
                            <div class="flex justify-between items-center">
                                Expir
                                <p-columnFilter type="boolean" field="Expir" display="menu"></p-columnFilter>
                            </div>
                        </th>
                        <th style="min-width: 8rem">
                            <div class="flex justify-between items-center">
  ...
  <div class="flex gap-2">
    <p-button icon="pi pi-pencil" severity="info" size="small"></p-button>
    <p-button icon="pi pi-trash" severity="danger" size="small"></p-button>
    <p-button icon="pi pi-print" severity="secondary" size="small"></p-button>
  </div>
</td>
